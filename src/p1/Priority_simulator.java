...
public class Priority_simulator
{
...
//        chartPanel.setPreferredSize(new Dimension(700, 10));
        ...
        option = new JComboBox(new String[]{"PSN", "PSP"});
        ...
        computeBtn.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                CPUSchedular scheduler;
                
                switch (selected) {  
                   case "PSN":
                        scheduler = new priority_logic();
                        break;
                    case "PSP":
                        scheduler = new Priority_premp_logic();
                        break;
                    default:
                        return;
                }
